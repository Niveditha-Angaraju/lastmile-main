...
class RiderService(rider_pb2_grpc.RiderServiceServicer):
    def RegisterRider(self, request, context):
        """
        Register a rider with UPSERT logic.
        ON CONFLICT DO UPDATE allows re-registering the same rider_id
        without errors - it will update the existing record instead.
        This is useful for:
        - Re-registering riders
        - Updating rider information
        - Handling duplicate registration attempts gracefully
        """
